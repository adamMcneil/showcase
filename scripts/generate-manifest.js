...
function main() {
  ...
  for (const d of dirs) {
    ...
    // check if "first.jpg" exists, otherwise use the first file
    const firstJpgIndex = files.findIndex(f => f.toLowerCase() === 'first.jpg')
    const first = firstJpgIndex !== -1 ? filesPosix[firstJpgIndex] : filesPosix[0]
